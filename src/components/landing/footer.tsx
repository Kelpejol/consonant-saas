...
const footerLinks = {
  ...
  developers: [
    ...
    { label: "GitHub", href: "https://github.com/consonant" },
  ],
  company: [
    { label: "About", href: "/about" },
    { label: "Blog", href: "/blog" },
    { label: "Contact", href: "/contact" },
    { label: "Status", href: "https://status.consonant.dev" },
  ],
  legal: [
        ...
        <div className="grid lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed mb-6 max-w-xs">
              Real-time AI cost enforcement for B2B SaaS. Protect your margins automatically.
            </p>
            <div className="flex items-center gap-4">
              <a 
                href="https://twitter.com/consonantdev" 
                target="_blank" 
              ...
              <a 
                href="https://github.com/consonant" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-black transition-colors"
              >
              ...
              <a 
                href="https://linkedin.com/company/consonant" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-black transition-colors"
              >
          ...
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Developers</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-semibold text-black text-sm mb-4">Legal</h4>
            <ul className="space-y-3">
