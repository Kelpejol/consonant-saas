      ...
      <div className="relative flex flex-col justify-start items-center w-full">
        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            {/* Navigation */}
            <div className="fixed left-0 top-0 w-full z-50 flex justify-center items-center h-12 sm:h-14 md:h-16 lg:h-[84px] px-6 sm:px-8 md:px-12 lg:px-0 bg-black">
              <div className="w-full h-0 absolute left-0 top-6 sm:top-7 md:top-8 lg:top-[42px] border-t border-[rgba(255,255,255,0.06)]"></div>

              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-transparent backdrop-blur-sm shadow-none overflow-hidden rounded-none flex justify-between items-center relative z-30 text-white">
                <div className="flex justify-center items-center">
                  ...
                  <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 flex justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
                    <div className="flex justify-start items-center">
                      <div className="flex flex-col justify-center text-white/90 text-xs md:text-[13px] font-medium leading-[14px] font-sans">
                        Products
                      </div>
                    </div>
                    <div className="flex justify-start items-center">
                ...
                <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                  <div className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-transparent border border-white/10 overflow-hidden rounded-full flex justify-center items-center">
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Lightweight SDKs, simple API, and transparent pricing
                      <br className="hidden sm:block" />
                      for AI-powered applications at scale.
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                ...
                <div className="self-stretch flex justify-center items-start">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    {/* Top Left - Real-time enforcement */}
                    <div className="border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Instantly verify spending limits before each AI request with sub-millisecond latency.
                        </p>
                      </div>
                    ...
                    <div className="border-b border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Lightweight TypeScript and Python SDKs integrate seamlessly with OpenAI, Anthropic, and more.
                        </p>
                      </div>
                    ...
                    <div className="border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6 bg-transparent">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Works with OpenAI, Anthropic, Groq, and any AI provider. Use Helicone, Portkey, or direct.
                        </p>
                      </div>
                    ...
                    {/* Bottom Right - Detailed Analytics */}
                    <div className="p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="text-[#605A57] text-sm md:text-base font-normal leading-relaxed font-sans">
                          Monitor per-customer spending, token usage, and profitability with comprehensive dashboards.
                        </p>
                      </div>
