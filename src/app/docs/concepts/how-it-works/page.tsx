  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8 space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">Before any AI request, the SDK performs a <strong>balance check</strong>:</p>
        <CodeBlock
          language="typescript"
          filename="flow.ts"
...
// 4. If approved, request proceeds; if not, throws error`}
        ...
        <p className="text-gray-600 dark:text-gray-400">For streaming responses, the SDK deducts costs <strong>in real-time</strong>:</p>
        <CodeBlock
          language="text"
          filename="stream_log"
...
Token 101+:   ...continues until stream ends`}
        ...
        <p className="text-gray-600 dark:text-gray-400">When the AI provider returns final usage data:</p>
        <CodeBlock
          language="typescript"
...
// Backend calculates precise cost and refunds any over-reservation`}
      ...
      <div className="mt-8 space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">Every request is attributed to a specific customer using your <code>customerIdExtractor</code>:</p>
        <CodeBlock
          language="typescript"
  ...
  return context.stripeId     // Stripe customer ID
      ...
      <div className="mt-8 space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">Consonant stores:</p>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-4">We <strong>never store</strong>:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-400">
